...
urlpatterns = [
    ...
    path('', base_views.index, name='index'), #메인 페이지
    path('boardlist/', base_views.boardlist, name='boardlist'), #index
    path('<int:question_id>/', base_views.detail, name='detail'), #질문/답변 상세보기
